...
attributeDict={
                "Gender":[0.9384086799276673,0.9747377938517179],
                "Blackhair":[0.8387878787878787,0.8806060606060606]} 
...
@click.option("--classdir", type=str, help="path pointing to classifier directory", default="../CLEAM/attributeClassifier/src_MobileNetv2/results/attr_clf/")
...
def measure_dist(datadir,attribute,figheader,seed,classdir):
    ...
    #Scale down data
    data=F.interpolate(data, size=128)
    
    #Load Classifier
    classifier = mobilenet()
    CLF_PATH = os.path.join(classdir,str(SADict[attribute]),"model_best.pth.tar")
    ...
    distArray=[]
    labelledWrong=[]
    correctlyLabelled0=0
    totalLabel0=0
    correctlyLabelled1=0
    totalLabel1=0
