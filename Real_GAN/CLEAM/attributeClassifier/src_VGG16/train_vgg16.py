...
class_idx=20
train_dataset = build_even_celeba_classification_dataset('train',class_idx)
train_loader = torch.utils.data.DataLoader(train_dataset, batch_size=BATCH_SIZE, shuffle=True)

test_dataset = build_even_celeba_classification_dataset('test',class_idx)
test_loader = torch.utils.data.DataLoader(test_dataset, batch_size=BATCH_SIZE, shuffle=False)


val_dataset = build_even_celeba_classification_dataset('val',class_idx)
...
torch.save(model.state_dict(), "./VGG16_CelebA_{}.pt".format(attributesDict[class_idx]))