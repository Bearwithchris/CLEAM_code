...
if __name__ == "__main__":
    ...
    train_dataset = build_multi_even_celeba_classification_datset(OUT_DIR,
          'train')
    valid_dataset = build_multi_even_celeba_classification_datset(OUT_DIR,
        'val')
    test_dataset = build_multi_even_celeba_classification_datset(OUT_DIR,
        'test')
    n_classes = 2
